...
恭喜大家！我們成功完成了 iThome 鐵人賽 30 天的挑戰，從零打造出專為升學面試設計的智慧教育 Agent 系統 —— **UniMock AI**。

---

## 1. 30 天五大階段架構覆盤

- **階段一（Day 1–5）：** 確立願景、Antigravity 環境配置、Google AI Studio Gemma-4-31B-it 串接與 Stitch UI 原型逆向工程。
...
未來我們預計擴充：
1. 支援更多開放模型（如 Gemini 1.5 Pro / Gemma 2）。
